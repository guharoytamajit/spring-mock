...
public class ExamplePojoTest {
	@Spy
	ExamplePojo spyExamplePojo =new ExamplePojo();
	@Test
	public void testMethodMakingPrivateMethodCall() throws Exception {
		...
		when(spyExamplePojo,
				method(ExamplePojo.class, "privateMethod", String.class))
				.withArguments(anyString()).thenReturn("test test");
	...
	public void testMethodMakingStaticNonVoidMethodCall() throws Exception {
		...
		String result = new ExamplePojo()
				.methodMakingStaticNonVoidMethodCall("test");
		assertEquals("test test", result);
	}
